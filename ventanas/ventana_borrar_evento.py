...
class VentanaBorrarEvento(tk.Toplevel):
    ...
    def interfaz(self, usuario):
        ...
        for evento in lista_eventos:
            ...
            self.botones_eventos[evento[2]] = tk.Button(self, text=f"{evento[2]}, {evento[3]}", command=self.borrar_evento)
            self.botones_eventos[evento[2]].place(x=20, y=y_actual)
    ...
    def borrar_evento(self):
        ...
        self.app.gestion.borrar_evento(self.evento_actual, self.usuario)
